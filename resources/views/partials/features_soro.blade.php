                                    ...
                                    <div class="border border-[#E5E7EB] bg-white rounded-xl w-full shadow-lg mx-auto">
                                        <div class="overflow-x-hidden overflow-y-visible rounded-t-xl">
                                            <div class="grid grid-cols-2 md:grid-cols-4 relative" style="height:auto; min-height:110px; width:100%">
                                                ...
                                                <!-- Brand Red Box -->
                                                <div class="bg-[#2563EB] relative w-full h-[110px]">
                                                ...
                                                <div class="absolute"
                                                    ...
                                                    <div class="absolute"
                                                        ...
                                                        <div class="relative flex items-center justify-center bg-white rounded-full"
                                                            style="width:48px;height:48px;box-shadow:0 4px 20px rgba(37, 99, 235, 0.25), 0 2px 8px rgba(0, 0, 0, 0.1);border:2px solid #2563EB">
                                                            <img src="{{ asset('Images/Alphafin_logo_FA-01.png') }}" alt="Alphafin Logo"
                                                                class="w-8 h-8 rounded-full shadow-[0_0_15px_rgba(37,99,235,0.6)] object-contain">
                                                        </div>
                                                        <div class="absolute"
